...
public class TransactionReport extends javax.swing.JFrame {
    ...
    private void showTranscationsReport()
    {
        ...
        report.append(String.format("%-12s %-12s %-20s %-15s %-10s %-10s %-10s %-30s\n",
            "Doc ID", "Username", "Name", "Date", "Amount", "Block", "Lot", "Location"))
              .append("-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n");

        // Add Invoice data to report
        for (Invoice invoice : Data.invoices) {
            report.append(String.format("%-12s %-12s %-20s %-15s %-10.2f %-10d %-10d %-30s\n",
        ...
        // Add section for Receipts
        report.append("\n----------------------------------------------------------------------------------------------------------------------------------------------------------------------\n")
              .append("\t\t\tReceipt List\n")
              .append("-------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n\n");

        // Receipt Table Header
        report.append(String.format("%-12s %-12s %-20s %-15s %-10s %-10s %-10s %-15s %-30s\n",
            "Doc ID", "Username", "Name", "Date", "Amount", "Block", "Lot", "Location", "Payment Method"))
              .append("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n");

        // Add Receipt data to report
        for (Receipt receipt : Data.receipts) {
            report.append(String.format("%-12s %-12s %-20s %-15s %-10.2f %-10d %-10d %-15s %-30s\n",
